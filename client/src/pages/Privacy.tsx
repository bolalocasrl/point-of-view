...
export default function Privacy() {
  return (
    <LegalPage label="Legal" title="Privacy Policy" updated="September 17, 2026">
      ...
      <LegalSection title="Cookies">
        <p>
          This website does not use advertising cookies. We only store a small preference in your browser to remember
          whether you already closed or used the newsletter pop-up. If we add analytics or advertising tools in the
          future, this policy will be updated and, where required, your consent will be asked first.
        </p>
      </LegalSection>
